...
class SchemaLoaderTC(TestCase):
    ...
    def test_vocabulary(self):
        eschema = self.schema.eschema('pkginfo')
    ...
    def test_rschema(self):
        ...
        rschema = self.schema.rschema('sym_rel')
